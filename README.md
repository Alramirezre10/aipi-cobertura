...
GitHub Actions ejecuta el workflow automáticamente todos los días.
report_runner.py descarga desde OneDrive:
archivos de INSTITUCIONAL_8H
archivos de JARDINES_INTEGRALES
archivo DICCIONARIO.xlsx
cobertura.py consolida, valida y transforma la información.
Se generan outputs analíticos:
AIPI_COBERTURA.parquet
AIPI_COBERTURA.xlsx
Los outputs se cargan nuevamente a OneDrive.
GitHub Actions
Trigger Manual
workflow_dispatch:
Trigger Automático
